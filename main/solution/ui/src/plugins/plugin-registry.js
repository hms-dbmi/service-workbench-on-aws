...
// @aws-ee/custom
import registerAppContextPlugin from '@aws-ee/custom/dist/plugins/app-context-items-plugin';
import registerAppComponentPlugin from '@aws-ee/custom/dist/plugins/app-component-plugin';
import registerRoutesPlugin from '@aws-ee/custom/dist/plugins/routes-plugin';
...
const extensionPoints = {
  'app-context-items': [
    ...
    registerAppContextPlugin, // @aws-ee/custom
  ...
  'app-component': [
    ...
    registerAppComponentPlugin, // @aws-ee/custom
  ],
  'menu-items': [
  ...
  'routes': [
    ...
    registerRoutesPlugin, // @aws-ee/custom
